...
public class OrderServiceDetailDAO {
    ...
    public ArrayList<OrderServiceDetailDTO> getOrderBoardingDetailById(String orderId) throws SQLException, ClassNotFoundException {
        Connection con = null;
        ResultSet rs = null;
        ...
        try {
            ...
            if (con != null) {
                ...
                while (rs.next()) {
                    ...
                    pDAO.searchPetById(rs.getString("petId")));
